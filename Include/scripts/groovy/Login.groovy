...
class Login {
	...
	def I_click_masuk_button() {
		Mobile.tap(findTestObject('Object Repository/3/masuk_button'), 0)
	}

	@And("I input my email (.*) on the login page")
	...
	@And("I input my password (.*) on the login page")
	def I_input_password_on_the_login_page(String Password) {
		Mobile.tap(findTestObject('Object Repository/3/Tap_pw_login_page'), 30)

		Mobile.setText(findTestObject('Object Repository/3/setText_Pw_login_page'), Password , 30)
	}

	@And("click masuk button on the login page")
	def click_masuk_button_on_the_login_page() {
		Mobile.tap(findTestObject('Object Repository/3/Masuk_btn_on_the_login_page'), 30)
	}

	@Then("I can verify the homepage")
	def I_verify_on_the_homepage() {
